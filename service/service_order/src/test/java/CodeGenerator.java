...
//        String projectPath = System.getProperty("user.dir");
        gc.setOutputDir("C:\\Users\\Administrator\\Desktop\\xm\\guli_parent-master\\service\\service_order" + "/src/main/java");
        ...
        pc.setModuleName("orderservice");//模块名称
        ...
        strategy.setTablePrefix("t"+"_");//生成实体类时去掉表前缀，实际执行没有去掉
